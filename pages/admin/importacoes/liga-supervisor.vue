<template>
  <div>
    <header class="mb-6">
      <h1 class="text-2xl font-bold text-primary-600">Importação — Liga Supervisor</h1>
      <p class="text-sm text-gray-500">Upload do arquivo de ligações para supervisores.</p>
    </header>
